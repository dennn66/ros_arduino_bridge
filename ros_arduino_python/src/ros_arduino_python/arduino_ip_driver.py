...
class ArduinoIP:
    ...
    def connect(self):
        ...
        self.socket.connect((self.remote_ip , self.tcp_port))
        print 'Socket Connected to ' + self.remote_ip + ' on port ' + str(self.tcp_port)
